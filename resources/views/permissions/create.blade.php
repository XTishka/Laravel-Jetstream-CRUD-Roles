            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('permissions.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="name" class="block font-medium text-sm text-gray-700">Slug</label>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <textarea id="description" name="description" rows="3" class="form-textarea shadow-sm focus:ring-indigo-500 mt-1 block w-full sm:text-sm rounded-md">{{ old('description', '') }}</textarea>
                            @error('description')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
